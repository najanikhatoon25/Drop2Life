...
Prerequisites
For Software: Node.js (v18 or higher), Git
For Hardware Simulation: Arduino IDE or Wokwi Simulator
...
🛠 Tech Stack
Frontend | React.js / Tailwind CSS | | Backend | Node.js / Express.js | | Database | SQLite / Firebase (To store daily volume stats) |
